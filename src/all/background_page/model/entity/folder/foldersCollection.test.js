...
describe("Folders collection entity", () => {
            ...
            user: {
              ...
              profile: {
                ...
                avatar: {
                  ...
                  url: {
                    medium:
                      "img\/public\/Avatar\/84\/a1\/21\/5426cb53d90940eb920238f2c1f94084\/5426cb53d90940eb920238f2c1f94084.a99472d5.png",
                    small:
                      "img\/public\/Avatar\/84\/a1\/21\/5426cb53d90940eb920238f2c1f94084\/5426cb53d90940eb920238f2c1f94084.65a0ba70.png",
                  },
                },
              },
              last_logged_in: "",
  ...
  it("getAllChildren works", () => {
    ...
    expect(result.items.map((r) => r.id)).toEqual(["e2172205-139c-4e4b-a03a-933528123f04"]);
  ...
  describe("::filterByIsOwner", () => {
    it("filters the collection by folders having a owner permission.", () => {
      ...
      const folder1Dto = defaultFolderDto({
        id: folder1Id,
        permission: ownerPermissionDto({ aco: PermissionEntity.ACO_FOLDER, aco_foreign_key: folder1Id }),
      });
      const folder2Id = uuidv4();
      const folder2Dto = defaultFolderDto({
        id: folder2Id,
        permission: updatePermissionDto({ aco: PermissionEntity.ACO_FOLDER, aco_foreign_key: folder2Id }),
      });
      const folder3Id = uuidv4();
      const folder3Dto = defaultFolderDto({
        id: folder3Id,
        permission: readPermissionDto({ aco: PermissionEntity.ACO_FOLDER, aco_foreign_key: folder3Id }),
      });
      const folder4Id = uuidv4();
      const folder4Dto = defaultFolderDto({
        id: folder4Id,
        permission: ownerPermissionDto({ aco: PermissionEntity.ACO_FOLDER, aco_foreign_key: folder4Id }),
      });
      const folders = new FoldersCollection([folder1Dto, folder2Dto, folder3Dto, folder4Dto]);
