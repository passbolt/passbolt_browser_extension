...
describe("RecoverBootstrap", () => {
  ...
  describe("RecoverBootstrap::injectFile", () => {
    it("Should inject file", async () => {
      ...
      expect(RecoverBootstrap.contentStyleFiles).toStrictEqual([
        "webAccessibleResources/css/themes/default/ext_external.min.css",
      ]);
      expect(RecoverBootstrap.contentScriptFiles).toStrictEqual([
  ...
  describe("RecoverBootstrap::canBeAttachedTo", () => {
    ...
    each([
      ...
      {
        scenario: "No token",
        url: "https://passbolt.dev/setup/recover/start/571bec7e-6cce-451d-b53a-f8c93e147228",
        frameId: Pagemod.TOP_FRAME_ID,
      },
      {
