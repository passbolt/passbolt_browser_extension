        ...
        <div className="back-link">
          <a href="#" className="primary-action" onClick={this.handleGoBackClick} title="Go back">
            ...
            <span className="primary-action-title">
              {this.state.selectedGroup && this.state.selectedGroup.name || "Groups"}
            </span>
          </a>
            ...
            {!isReady &&
              <li className="empty-entry">
                <p className="processing-text">
                  {listGroupsOnly ? "Retrieving your groups" : "Retrieving your passwords"}
                </p>
              </li>
            }
            {isReady &&
                    ...
                    {(!browsedGroups.length) &&
                      <li className="empty-entry">
                        <p>
                          ...
                          {!isSearching && "You are not member of any group. Wait for a group manager to add you in a group."}
                        </p>
                      </li>
                    }
                  ...
                  <React.Fragment>
                    {!browsedResources.length &&
                      <li className="empty-entry">
                        <p>
                          {isSearching && "No result match your search. Try with another search term."}
                          {!isSearching && "No passwords are shared with this group yet. Share a password with this group or wait for a team \
                            member to share one with this group."}
                        </p>
                      </li>
                    }
...
export default withRouter(FilterResourcesByGroupPage);
