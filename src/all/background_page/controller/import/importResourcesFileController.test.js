...
describe("ImportResourcesFileController", () => {
  ...
  describe("::exec", () => {
    ...
    describe("Should parse kdbx file and import resources.", () => {
      it("should import non encrypted kdbx", async() => {
      ...
      it("should import encrypted with password kdbx", async() => {
        expect.assertions(4);
      ...
      it("should import encrypted with keyfile kdbx", async() => {
        expect.assertions(4);
    ...
    describe("Should parse csv file and import resources.", () => {
      each([
        {scenario: "chromium", file: chromiumCsvFileImport},
        {scenario: "mozilla", file: mozillaCsvFileImport},
      ]).describe("should parse minimal csv", test => {
        it(`should parse ${test.scenario} csv file`, async() => {
          expect.assertions(4);
      ...
      each([
        {scenario: "dashlane", file: dashlaneCsvFileImport},
        {scenario: "safari", file: safariCsvFileImport},
      ...
      each([
        ...
        {scenario: "bitwarden", file: bitwardenCsvFileImport},
        {scenario: "lastpass", file: lastpassCsvFileImport},
        {scenario: "logMeOnce", file: logMeOnceCsvFileImport},
      ...
      each([
        {scenario: "keypass", file: defaultKDBXCSVData},
