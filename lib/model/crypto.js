...
Crypto.getOpenpgpWorker = function() {
    var openpgpWorker = new openpgp.AsyncProxy(Config.read('extensionBasePath') + "/lib/vendors/openpgp.worker.js");
    return openpgpWorker;
}
...
Crypto.encrypt = function(armoredKey, message) {
    ...
    // Encrypt message.
    var deferred = openpgpWorker.encryptMessage(publicKey.keys, message);
