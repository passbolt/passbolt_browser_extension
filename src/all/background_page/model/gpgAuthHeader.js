...
GpgAuthHeader.prototype.__validateCommonAllStage = function () {
  ...
  if (typeof this.headers["x-gpgauth-version"] !== "string" || this.headers["x-gpgauth-version"] !== "1.3.0") {
...
GpgAuthHeader.prototype.__validateByStage = function (stage) {
  ...
  switch (stage) {
    case "logout":
      if (
        typeof this.headers["x-gpgauth-authenticated"] !== "string" ||
    ...
    case "stage0":
      ...
      if (typeof this.headers["x-gpgauth-progress"] !== "string" || this.headers["x-gpgauth-progress"] != "stage0") {
      ...
      if (typeof this.headers["x-gpgauth-user-auth-token"] !== "undefined") {
        return new Error(
          `x-gpgauth-user-auth-token should not be set during the verify stage${typeof this.headers["x-gpgauth-user-auth-token"]}`,
        );
      }
    ...
    case "stage1":
      ...
      if (typeof this.headers["x-gpgauth-progress"] !== "string" || this.headers["x-gpgauth-progress"] != "stage1") {
    ...
    case "complete":
      ...
      if (typeof this.headers["x-gpgauth-progress"] !== "string" || this.headers["x-gpgauth-progress"] != "complete") {
