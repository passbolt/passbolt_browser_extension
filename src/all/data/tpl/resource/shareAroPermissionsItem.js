...
if (aroPermissions.aro.profile) {
    ...
    ; __line = 27
    ; __append(escapeFn( !isOwner ? 'disabled' : '' ))
    ; __append("\" ")
    ; __append(escapeFn( !isOwner ? 'disabled="disabled"' : '' ))
    ; __append(">\n            <option value=\"1\" ")
    ; __line = 28
