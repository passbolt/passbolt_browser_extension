...
local_resource('npm-link',
                cmd='docker run -v ${PWD}:/app -v ${PWD%/*/*}/styleguide/passbolt-styleguide:/passbolt-styleguide -w /app node:14.15.4 /bin/bash -c "npm link ../passbolt-styleguide"')
local_resource('build-chrome-ext',
                cmd='docker run -v ${PWD}:/app -v ${PWD%/*/*}/styleguide/passbolt-styleguide:/passbolt-styleguide -w /app node:14.15.4 /bin/bash -c "npm install && npx grunt build-chrome-debug"',
                deps=['src'],
