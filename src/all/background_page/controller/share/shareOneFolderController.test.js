...
describe("ShareOneFolderController", () => {
  describe("::exec", () => {
    ...
    it("shares one folder and its content.", async () => {
      ...
      jest
        .spyOn(controller.getOrFindFoldersService, "getOrFindAll")
      ...
      expect(controller.shareFoldersService.shareOneWithContent).toHaveBeenCalledWith(
        folderIdToShare,
        new PermissionChangesCollection(permissionsChangesDto),
