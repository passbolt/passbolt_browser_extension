...
const privateKeyPasswordCollectionDto = [{
...
exports.mockedData = {
  privateKeyPasswordCollectionDto: privateKeyPasswordCollectionDto,
  policyDtos: policyDtos,
  privateKeyDtos: privateKeyDtos
};
