  ...
  describe("AutofillController::exec", () => {
    it("Should autofill from inform menu.", async () => {
      ...
      jest
        ...
        .mockImplementationOnce(() => pgpKeys.ada.passphrase);
      jest.spyOn(controller.resourceModel, "getById").mockImplementationOnce(() => resource);
      jest
        .spyOn(controller.findSecretService, "findByResourceId")
        .mockImplementationOnce(() => new SecretEntity(secretDto));
      ...
      jest
        ...
        .mockImplementationOnce(() => pgpKeys.ada.private_decrypted);
