                ...
                {!browsedResources.length &&
                  <li className="empty-entry">
                    <p>
                      ...
                      {!isSearching && "It does feel a bit empty here. Create your first password or \
                        wait for a team member to share one with you."}
                    </p>
                  </li>
                }
...
FilterResourcesByRecentlyModifiedPage.contextType = AppContext;
...
export default withRouter(FilterResourcesByRecentlyModifiedPage);
