...
describe("EnableEncryptedMetadataForExistingInstanceController", () => {
  describe("::exec", () => {
    it("should call for the orchestrator to enable metadata", async () => {
      ...
      jest
        .spyOn(controller.configureMetadataSettingsService, "enableEncryptedMetadataForExistingInstance")
        .mockImplementation(() => {});
      ...
      expect(
        controller.configureMetadataSettingsService.enableEncryptedMetadataForExistingInstance,
