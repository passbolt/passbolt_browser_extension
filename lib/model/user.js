...
User.prototype.set = function (user) {
	...
	this.setId(user.id);
	this.setUsername(user._username);
...
User.prototype.get = function () {
	...
	this.__validate('id', user.id);
	this.__validate('username', user._username);
	this.__validate('firstname', user.firstname);
	this.__validate('lastname', user.lastname);
	return this._user;
};
