...
Setup.init = function() {
    ...
    Setup._pageMod = pageMod.PageMod({
        ...
        contentScriptFile: [
            ...
            self.data.url('js/inc/secretComplexity.js'),
            self.data.url('js/inc/setup/workflows/install_setup.workflow.js'),
            self.data.url('js/inc/setup/workflows/recover_setup.workflow.js'),
            ...
            self.data.url('js/inc/setup/login_redirection.js'),
