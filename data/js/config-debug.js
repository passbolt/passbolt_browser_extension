...
$(function() {
    ...
    $('#js_save_conf').click(function() {
        ...
        // try to save the firstname and lastname
        passbolt.request('passbolt.user.setName', firstname, lastname).then(
            function success() {
                console.log('firstname and last name have been saved!');
            },
            function error(msg) {
                console.log('Error: ' + msg);
            }
        ...
        passbolt.request('passbolt.user.setUsername', username).then(
            function success() {
