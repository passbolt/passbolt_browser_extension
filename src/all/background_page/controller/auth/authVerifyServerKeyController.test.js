...
describe("AuthVerifyServerKeyController", () => {
  describe("::exec", () => {
    ...
    it("Should throw a server key has changed error", async () => {
      ...
      jest
        .spyOn(controller.authVerifyServerKeyService, "getServerKey")
    ...
    it("Should throw a server error if the server cannot be verified", async () => {
      ...
      jest.spyOn(controller.authVerifyServerKeyService, "getServerKey").mockImplementationOnce(() => {
    ...
    it("Should throw a the message error in case of no content status", async () => {
      ...
      jest
        .spyOn(controller.authVerifyServerChallengeService.authVerifyServerKeyService.apiClient, "parseResponseJson")
