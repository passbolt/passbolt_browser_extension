  ...
  render() {
    return (
      <div className="quickaccess-header">
        <h1 className="logo">
          <a href={this.context.user ? this.context.user["user.settings.trustedDomain"] : "#"} target="_blank" rel="noopener noreferrer" title={this.translate("open passbolt in a new tab")}>
