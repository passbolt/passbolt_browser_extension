 ...
 */
User.prototype._getLocal = function() {
	this._user.id = Config.read('user.id');
	this._user.username = Config.read('user.username');
	this._user.firstname = Config.read('user.firstname');
	this._user.lastname = Config.read('user.lastname');
	try {
