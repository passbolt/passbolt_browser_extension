...
var listen = function (worker) {
  ...
  //
  // @fires passbolt.share.add-permission on the App worker
  // @property {array} permission - The temporary permission to add to list of permission
  //
  // @fires passbolt.share.reset on the Share worker
