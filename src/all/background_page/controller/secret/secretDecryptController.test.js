...
import {resourceWithEncryptedDescriptionDto} from "../../model/entity/plaintext/plaintextEntity.test.data";
import {mockApiResponse} from "../../../../../test/mocks/mockApiResponse";
import {v4 as uuidv4} from "uuid";
import {
  TEST_RESOURCE_TYPE_RESOURCE_WITH_ENCRYPTED_DESCRIPTION,
  TEST_RESOURCE_TYPE_RESOURCE_WITH_STRING_PASSWORD
...
describe("SecretDecryptController", () => {
  describe("SecretDecryptController::exec", () => {
    it("Decrypt successfully a resource with encrypted description.", async() => {
      ...
      const plaintextSecretDto = resourceWithEncryptedDescriptionDto();
      ...
      const resourceDto = defaultResourceDto({
        id: resourceId,
        resource_type_id: TEST_RESOURCE_TYPE_RESOURCE_WITH_ENCRYPTED_DESCRIPTION,
        secrets: [secretDto]
      });
