  ...
  describe("GetAccountRecoveryOrganizationPolicyController::exec", () => {
    it("Should return the account recovery organization policy", async () => {
      ...
      jest
        ...
        .mockImplementationOnce(() => ({ accountRecoveryOrganizationPolicy: accountRecoveryOrganizationPolicy }));

      const controller = new GetAccountRecoveryOrganizationPolicyController(
