...
Setup.init = function () {
  ...
  Setup._pageMod = pageMod.PageMod({
    ...
    contentScriptFile: [
      ...
      self.data.url('js/setup/workflow/install_setup.workflow.js'),
      self.data.url('js/setup/workflow/recover_setup.workflow.js'),
      self.data.url('js/setup/step/domain_check.js'),
      self.data.url('js/setup/step/define_key.js'),
      self.data.url('js/setup/step/import_key.js'),
      self.data.url('js/setup/step/secret.js'),
      self.data.url('js/setup/step/generate_key.js'),
      self.data.url('js/setup/step/backup_key.js'),
      self.data.url('js/setup/step/key_info.js'),
      self.data.url('js/setup/step/security_token.js'),
      self.data.url('js/setup/step/login_redirection.js'),
