...
import {ImportPrivateKeySetupController} from "./importPrivateKeySetupController";
...
describe("ImportPrivateKeySetupController", () => {
  describe('ImportPrivateKeySetupController::constructor', () => {
    it("Should throw an exception if the setupEntity is not formatted properly.", () => {
      ...
      for (let i = 0; i < scenarios.length; i++) {
        ...
        try {
          new ImportPrivateKeySetupController(null, null, scenario.setupEntity);
        } catch (e) {
    ...
    it("Should accept a well formatted SetupEntity.", () => {
      ...
      const controller = new ImportPrivateKeySetupController(null, null, setupEntity);
