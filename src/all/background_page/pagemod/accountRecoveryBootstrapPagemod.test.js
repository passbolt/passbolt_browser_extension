...
describe("AccountRecoveryBootstrap", () => {
  ...
  describe("AccountRecoveryBootstrap::injectFile", () => {
    it("Should inject file", async () => {
      ...
      expect(AccountRecoveryBootstrap.contentScriptFiles).toStrictEqual([
  ...
  describe("AccountRecoveryBootstrap::attachEvents", () => {
    it("Should attach events", async () => {
      ...
      expect(PortEvents.listen).toHaveBeenCalledWith({
        ...
        name: AccountRecoveryBootstrap.appName,
      });
    });
  });
  ...
  describe("AccountRecoveryBootstrap::canBeAttachedTo", () => {
    ...
    each([
      ...
      {
        scenario: "No token",
        url: "https://passbolt.dev/account-recovery/continue/d57c10f5-639d-5160-9c81-8a0c6c4ec856",
        frameId: Pagemod.TOP_FRAME_ID,
      },
      {
