        ...
        try {
            setup.checkKeyExistRemotely(fingerprint)
                .then(
                    ...
                    function (error) {
                        worker.port.emit('passbolt.setup.checkKeyExistRemotely.complete', token, 'ERROR', error);
                    }
              );
        }
        catch (e) {
            worker.port.emit('passbolt.setup.checkKeyExistRemotely.complete', token, 'ERROR', e.message);
        }
    });
