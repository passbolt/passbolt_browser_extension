...
describe("SetupBootstrap", () => {
  ...
  describe("SetupBootstrap::injectFile", () => {
    it("Should inject file", async () => {
      ...
      expect(SetupBootstrap.contentStyleFiles).toStrictEqual([
        "webAccessibleResources/css/themes/default/ext_external.min.css",
      ]);
      expect(SetupBootstrap.contentScriptFiles).toStrictEqual([
  ...
  describe("SetupBootstrap::canBeAttachedTo", () => {
    ...
    each([
      {
        scenario: "No domain",
        url: "setup/start/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0",
        frameId: Pagemod.TOP_FRAME_ID,
      },
      {
        scenario: "No token",
        url: "https://passbolt.dev/setup/start/571bec7e-6cce-451d-b53a-f8c93e147228",
        frameId: Pagemod.TOP_FRAME_ID,
      },
      {
        scenario: "Not top frame",
        url: "https://passbolt.dev/setup/start/571bec7e-6cce-451d-b53a-f8c93e147228/5ea0fc9c-b180-4873-8e00-9457862e43e0",
        frameId: 1,
      },
