                ...
                {!browsedResources.length &&
                  <li className="empty-entry">
                    <p>
                      ...
                      {!isSearching && "None of your passwords are yet marked as favorite. \
                        Add stars to passwords you want to easily find later."}
                    </p>
                  </li>
                }
...
FilterResourcesByFavoritePage.contextType = AppContext;
...
export default withRouter(FilterResourcesByFavoritePage);
