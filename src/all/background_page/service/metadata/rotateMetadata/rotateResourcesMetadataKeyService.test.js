...
describe("RotateResourcesMetadataKeyService", () => {
  ...
  beforeEach(() => {
    ...
    metadataKeysDtos = [
      ...
      ...defaultDecryptedSharedMetadataKeysDtos({
        ...
        created: "2024-10-11T08:09:00+00:00",
  ...
  describe("::rotate", () => {
    it("should run the rotation process", async () => {
      ...
      const rotationDetails = new PassboltResponseEntity(
        passboltReponseWithCollectionDto(firstBatchToRotate, { header: apiResponseHeaderDto }),
      );
      ...
      // Spy initialization
      jest.spyOn(service.metadataRotateKeysResourcesApiService, "rotate").mockImplementation(async () =>
        rotateCallCount++ > 0
    ...
    it("should retry the process multiple times before aborting it", async () => {
      ...
      const service = new RotateResourcesMetadataKeyService(
        account,
