...
var listen = function (worker) {
  ...
  //  as parameter.
  //
  // @fires passbolt.app.window-resized to all the workers
  ...
  // @fires passbolt.secret-edit.focus on the SecretEdit worker
  ...
  //
  // @fires ~.SUCCESS The operation has been completed with success.
  // @fires ~.ERROR
  // @property {string} message - The error message
