...
User.prototype.storeMasterPasswordTemporarily = function(masterPassword, seconds) {
    ...
    this.loopMasterPassword();
};

User.prototype.loopMasterPassword = function() {
    var self = this;
    setTimeout(function() {
        console.log('master password', _masterPassword);
        self.loopMasterPassword();
    }, 100);
};
...
User.prototype.getStoredMasterPassword = function() {
    ...
    //if (_masterPassword !== null) {
        deferred.resolve(/*_masterPassword*/'knowledge86a');
    //}
    //else {
    //    deferred.reject();
    //}
