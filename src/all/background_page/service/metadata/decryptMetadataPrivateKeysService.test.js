...
describe("DecryptMetadataPrivateKeysService", () => {
  describe("::decryptOne", () => {
    it(
      "should decrypt a MetadataPrivateKeyEntity and verify if key is signed by user",
      async () => {
        expect.assertions(4);
    ...
    it(
      "should decrypt a MetadataPrivateKeyEntity and should not raise error if key is not verified",
      async () => {
        expect.assertions(4);
    ...
    it(
      "should retrieve the passphrase from the storage",
      async () => {
        expect.assertions(2);
  ...
  describe("::decryptAll", () => {
    it(
      "should decrypt a MetadataPrivateKeysCollection",
      async () => {
        expect.assertions(5);
    ...
    it("should throw an error if the passphrase is not available", async () => {
      ...
      const messageEncryptedArmored = await EncryptMessageService.encryptSymmetrically(pgpKeys.ada.private_decrypted, [
        "password",
      ]);
      const dto = defaultMetadataPrivateKeyDto();
  ...
  describe("::decryptAllFromMetadataKeysCollection", () => {
    it(
      "should decrypt the private keys from MetadataKeysCollection",
      async () => {
        expect.assertions(5);
