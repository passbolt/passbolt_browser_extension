...
pageMods.passboltApp = passboltApp.reset();
exports.initPassboltAppPageMod = passboltApp.reset;
...
var PassboltAuth = require('./pagemod/passboltAuthPagemod').PassboltAuth,
    passboltAuth = new PassboltAuth();
pageMods.passboltAuth = passboltAuth.reset();
