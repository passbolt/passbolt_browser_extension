...
describe("ShareResourcesController", () => {
  describe("::exec", () => {
    ...
    it("shares resources.", async () => {
      ...
      jest
        .spyOn(controller.shareResourceService.getOrFindResourcesService, "getOrFindAll")
      ...
      jest
        .spyOn(controller.shareResourceService.findResourcesService, "findAllByIdsForShare")
        .mockImplementation(() => new ResourcesCollection([resourceForShareDto]));
      // Mock keyring.
      ...
      jest
        .spyOn(controller.shareResourceService.findAndUpdateResourcesLocalStorage, "findAndUpdateAll")
      ...
      await expect(shareRequestData.secrets[0].data).toDecryptAndEqualTo(
        pgpKeys.carol.private_decrypted,
        JSON.stringify(secretDto),
      );
      ...
      expect(controller.progressService.finishStep).toHaveBeenNthCalledWith(
        8,
