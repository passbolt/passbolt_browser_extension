    ...
    return (
      <div className="index-list">
        <div className="back-link">
          <a href="#" className="primary-action" title="Go back" onClick={this.handleGoBackClick}>
          ...
          <ul className="list-items">
            <li className="filter-entry">
              <Link to={"/data/quickaccess/resources/favorite"}>
                ...
                <span className="filter">Favorites</span>
              </Link>
            </li>
            <li className="filter-entry">
              <Link to={"/data/quickaccess/resources/owned-by-me"}>
                ...
                <span className="filter">Items I own</span>
              </Link>
            </li>
            <li className="filter-entry">
              <Link to={"/data/quickaccess/resources/recently-modified"}>
                ...
                <span className="filter">Recently modified</span>
              </Link>
            </li>
            <li className="filter-entry">
              <Link to={"/data/quickaccess/resources/shared-with-me"}>
                ...
                <span className="filter">Shared with me</span>
              </Link>
            </li>
          </ul>
        </div>
