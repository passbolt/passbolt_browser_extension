...
describe("PermissionChangesCollection", () => {
  ...
  it("reuse changes works - part3 update - downgrade permission", () => {
    ...
    const permissions = new PermissionsCollection([
      {
        aco: PermissionEntity.ACO_FOLDER,
        aco_foreign_key: "192eb961-414c-43d4-9196-36dad47eed0e",
        aro: PermissionEntity.ARO_USER,
        aro_foreign_key: "e97b14ba-8957-57c9-a357-f78a6e1e1a46",
        created: "2020-12-16T04:34:16+00:00",
        group: null,
        id: "b5fcee7b-588f-4453-8230-e646aa38dac2",
        modified: "2020-12-16T04:34:16+00:00",
        type: PermissionEntity.PERMISSION_UPDATE,
      },
      {
        aco: PermissionEntity.ACO_FOLDER,
        ...
        aro: PermissionEntity.ARO_USER,
        aro_foreign_key: "f848277c-5398-58f8-a82a-72397af2d450",
        created: "2020-12-16T04:33:39+00:00",
        group: null,
        id: "7a9ce7a7-45a2-47c1-ac7c-167a48a4792a",
        modified: "2020-12-16T04:33:39+00:00",
        type: PermissionEntity.PERMISSION_OWNER,
      },
    ]);
    ...
    const changes = new PermissionChangesCollection([
      {
        aco: PermissionEntity.ACO_FOLDER,
        aco_foreign_key: "4074c78f-3988-4f54-beb9-afabcdbbdcde",
        aro: PermissionEntity.ARO_USER,
        aro_foreign_key: "e97b14ba-8957-57c9-a357-f78a6e1e1a46",
        id: "7e69e863-f69c-4185-ad38-af3c9adfbbab",
        type: PermissionEntity.PERMISSION_READ,
      },
    ]);
    ...
    const original = new PermissionsCollection([
      {
        ...
        group: null,
        id: "7e69e863-f69c-4185-ad38-af3c9adfbbab",
        modified: "2020-12-16T04:42:17+00:00",
        type: PermissionEntity.PERMISSION_UPDATE,
      },
      {
        aco: PermissionEntity.ACO_FOLDER,
        ...
        aro: PermissionEntity.ARO_USER,
        aro_foreign_key: "f848277c-5398-58f8-a82a-72397af2d450",
        created: "2020-12-16T04:33:33+00:00",
        group: null,
        id: "b741be47-48ef-436f-a5c7-02330ed99954",
        modified: "2020-12-16T04:33:33+00:00",
        type: PermissionEntity.PERMISSION_OWNER,
      },
    ]);
