    ...
    shell: {
      ...
      build_xpi: {
        ...
        command: [
          ...
          "sed --in-place='' -e 's/[\"]debug[\"]:.*$/\"debug\": true/' <%= config.build.firefox.path %>/lib/config/config.json",
          ...
          "sed --in-place='' -e 's/[\"]debug[\"]:.*$/\"debug\": false/' <%= config.build.firefox.path %>/lib/config/config.json",
          './node_modules/jpm/bin/jpm xpi --addon-dir <%= config.build.firefox.path %>',
      ...
      build_crx: {
        ...
        command: [
          ...
          "sed --in-place='' -e 's/[\"]debug[\"]:.*$/\"debug\": false/' <%= config.build.chrome.path %>/lib/config/config.json",
          ...
          "sed --in-place='' -e 's/[\"]debug[\"]:.*$/\"debug\": true/' <%= config.build.chrome.path %>/lib/config/config.json",
